...
return new class extends Migration
{
    ...
    {
        Schema::create('users', function (Blueprint $table) {  //sta creando una tabella attraverso la funzione create,    Schema è invece una classe di laravel
            // la tabella verra chiamata 'users' e quello che andro ad inserire dentro la tabella lo defnisco tramite una callback
            ...
            $table->string('name'); // con il metodo string() sto definendo una colonna contenente un dato di tipo string con un massimo di 255 caratteri
